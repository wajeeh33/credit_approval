defmodule CreditApprovalAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CreditApprovalAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CreditApprovalAppWeb.Gettext, "errors", msg, opts)
    end
  end
